...
:runNoClasspath
"%_JAVACMD%" %JDBACL_OPTS% -classpath "%LOCALCLASSPATH%" org.databene.jdbacl.swing.JdbaclGUI %*
goto end

:runWithClasspath
"%_JAVACMD%" %JDBACL_OPTS% -classpath "%CLASSPATH%;%LOCALCLASSPATH%" org.databene.jdbacl.swing.JdbaclGUI %*
goto end
